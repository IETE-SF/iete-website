...
class ProfessionalWebsite {
  ...
  nextHeroSlide() {
    this.heroSlider.currentSlide =
      (this.heroSlider.currentSlide + 1) % this.heroSlider.slides.length;
    this.updateHeroSlider();
  }

  prevHeroSlide() {
    this.heroSlider.currentSlide =
      this.heroSlider.currentSlide === 0
        ? this.heroSlider.slides.length - 1
        : this.heroSlider.currentSlide - 1;
    this.updateHeroSlider();
  }
  ...
  updateHeroSlider() {
    ...
    this.heroSlider.indicators.forEach((indicator, index) => {
      indicator.classList.toggle(
        "active",
        index === this.heroSlider.currentSlide
      );
    });
  }
  ...
  nextTestimonial() {
    this.testimonialSlider.currentSlide =
      ...
      this.testimonialSlider.slides.length;
  ...
  updateTestimonialSlider() {
    this.testimonialSlider.slides.forEach((slide, index) => {
      slide.classList.toggle(
        "active",
        index === this.testimonialSlider.currentSlide
      );
    });
  }
